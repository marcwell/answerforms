...
<table width="380" border="0" cellpadding="0" cellspacing="0" style="background-color: #F7F7F7; border: 2px solid #FFFFFF; padding: 5px;">
	...
	?>
		<tr>
			<td style="padding-top: 0px;padding-bottom: 0px; font-family: arial, verdana, helvetica; font-size: 11px;width:80px;" valign="top">Upload:</td>
			<td style="padding-top: 0px;padding-bottom: 0px;width:300px;"><input type="file" name="file" size="25" style="font-size: 10px; width: 100%;" /><?php if ( $allowuploads ) { ?><span><input type="submit" value="Upload" style="font-size: 12px;"><?php } ?></span></td>
		</tr>
		<tr>
...
<tr>
	<td colspan="2" align="right" style="padding-top: 5px;">
		<input type="submit" value="  Insert  " onClick="insertImage();return false;" style="font-size: 12px;">	
		<input type="button" value="  Cancel  " onClick="window.close();" style="font-size: 12px;">	
	</td>
</tr>
<tr><td>
<div id="display_div" style="width:150px; height:150px; border:1px solid #FFFFFF; text-align:center">
</div>
</td></tr>
</form>
</table>
