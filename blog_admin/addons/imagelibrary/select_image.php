...
if(height>width)
parent.document.getElementById("display_div").innerHTML="<img src='../../"+url+"' height=150 align=center>";
else
parent.document.getElementById("display_div").innerHTML="<img src='../../"+url+"' width=150 align=center>";
