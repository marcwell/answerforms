...
var WYSIWYG = {
	...
	execCommand: function(n, cmd, value) {
		...
		switch(cmd) {
			...
			// InsertImage
			case "InsertImage": 
				window.open(imagePopupFile + '?wysiwyg=' + n, 'popup', 'location=0,status=0,scrollbars=0,resizable=0,width=' + imagePopupWidth + ',height=410 ,top=' + popupPosition.top + ',left=' + popupPosition.left).focus();
			break;
